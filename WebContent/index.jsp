    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#table">Customer List</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h2>Spark Foundation</h2>
       
        </div>
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
          <img src="assets/img/bbbnak.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
       ...
       <div class="container" data-aos="fade-up">
          ...
          <h2>Costumer List</h2>
						...
						%>
                                ...
                                <tr>
                                     <th scope="row"><b><%=resultSet.getString("uid") %></b></th> 
                                    <td><%=resultSet.getString("uname") %></td>
                                    <td><b><%=resultSet.getString("umobile") %></b></td>
                                    <td><b><%=resultSet.getString("uemail") %></b></td>
                                    <td><b><%=resultSet.getString("uacount") %></b></td>
                                    <td><%=resultSet.getString("uamount") %></td>
                                    <td><a href="transection.jsp?aid=<%=resultSet.getString("uid") %>" ><input type="button" class="btn btn-info" value="Send Money"></a>
